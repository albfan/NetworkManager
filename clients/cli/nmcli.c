...
complete_fields (const char *prefix)
{
	...
	complete_field_new (h, "ip4-config", NM_META_SETTING_TYPE_IP4_CONFIG);
	complete_field_new (h, "ip6-config", NM_META_SETTING_TYPE_IP6_CONFIG);
	...
	complete_field_new (h, "olpc-mesh", NM_META_SETTING_TYPE_OLPC_MESH);
